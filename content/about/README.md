...
I didn't do it alone, though. My mentor and best friend [Emmanuel](https://github.com/emmanuelnk) had what seemed to be supernatural patience for helping me learn. My first real jobs came through WeChat groupchats, the everything marketplace of China. I taught myself enough to keep getting hired.
...
**[Akkadu](https://akkadu.com)** — A real-time remote simultaneous interpretation platform that lets multilingual audiences tune in to live interpretation streams during events. I worked with a team of developers to design the full-stack application, build the audio streaming infrastructure, and architect the cloud-based scaling on AWS using Node.js, Vue.js, PostgreSQL, Redis, and Elastic Beanstalk.
